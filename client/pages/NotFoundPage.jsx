...
import { StyledHorizontalLeftAlignContainer, VerticalContainer, StyledH1, StyledH2, PrimaryButton, StyledImage, StyledHorizontalContainer } from '../components/styles'; // replace with your actual file path
...
const NotFoundPage = () => {
  ...
  return (
    <>
    <Head title="Tablebooks - 404 Not Found" description="Page not found" siteContent="Tablebooks, restaurant reservations made simple"/>
